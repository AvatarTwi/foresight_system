...
from Calculate.condition import condition
from Calculate.inference import _node_likelihood
from Calculate.marginalization import marginalize
from Structure.nodes import Joint, Decomposition, Independent, eval_spn_bottom_up, Leaf, get_node_types
import logging
...
def Moment(spn, feature_scope=None, node_moment=_node_moment, node_likelihoods=_node_likelihood, order=1):
    ...
    node_moments = {Joint: sum_moment, Independent: prod_moment}
