...
from Structure.nodes import Joint, Decomposition, Independent, Leaf, get_nodes_by_type, eval_spn_bottom_up, assign_ids
...
def condition(spn, evidence):
    ...
    node_conditions.update({Joint: sum_condition, Independent: prod_condition})
