...
from Calculate.gradient import gradient_backward
from Calculate.inference import log_likelihood
from Learning.validity import is_valid

from Structure.nodes import Joint, get_nodes_by_type, get_number_of_nodes
import numpy as np
import logging
...
_node_updates = {Joint: sum_em_update}
