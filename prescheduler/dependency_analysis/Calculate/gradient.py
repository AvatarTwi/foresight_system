...
from Structure.nodes import eval_spn_top_down, Joint, Decomposition, Independent, Leaf, get_number_of_nodes, get_nodes_by_type
...
_node_gradients = {Joint: sum_gradient_backward, Independent: prod_gradient_backward, Leaf: leaf_gradient_backward}
